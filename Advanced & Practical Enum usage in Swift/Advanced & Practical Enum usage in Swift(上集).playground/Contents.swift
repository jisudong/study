...
//let mytrade = Trade_1.Sell(tp)       // removed in swift 3
let mytrade  = Trade_1.Sell(stock: "TSLA", amount: 100)
...
precedencegroup TuplePrecedence
{
    associativity: left
    higherThan: DefaultPrecedence
}

infix operator <^>: TuplePrecedence
...
print (Device_2.fromSlang(term: "iWatch"))
